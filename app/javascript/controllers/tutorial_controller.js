...
export default class extends Controller {
    ...
    showModal() {
        ...
        // モーダル要素を作成
        const modalHtml = `
            <div class="tutorial-modal fixed inset-0 z-50 overflow-y-auto bg-black bg-opacity-50" data-controller="tutorial">
                <div class="min-h-screen px-4 text-center">
                    <div class="fixed inset-0" data-action="click->tutorial#close"></div>
                    <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-4xl sm:w-full">
                        <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                            <div class="flex justify-between items-center mb-4">
                                <h3 class="text-lg leading-6 font-medium text-gray-900">🌱 ちいくさ日記の使い方</h3>
                                <button data-action="click->tutorial#close" class="text-gray-400 hover:text-gray-600">
                        ...
                        <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                            <button data-action="click->tutorial#close" class="w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-green-600 text-base font-medium text-white hover:bg-green-700 focus:outline-none sm:ml-3 sm:w-auto sm:text-sm">
                                始める
                            </button>
                        </div>
                    </div>
